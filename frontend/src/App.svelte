  ...
  <div id="container">
    <header class="header">
      <div>
          ...
          <p class="todays-paper">Today's Paper</p>
      </div>
      <div class="logo">
          <!-- This svg was directly inspected from the NYT website -->
          <svg viewBox="0 0 183.05 25">
    ...
    <div class = "section" id = "middle">
      <!-- Add the articles -->
      <h1>{articles[1]?.headline?.main}</h1>
    ...
    <div class = "section" id = "right">
      <!-- Add the articles -->
       <h1>{articles[2]?.headline?.main}</h1>
